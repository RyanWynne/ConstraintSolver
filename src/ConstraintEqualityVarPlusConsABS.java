public class ConstraintEqualityVarPlusConsABS extends Constraint {
	
	public ConstraintEqualityVarPlusConsABS(Variable v1, Variable v2, String val) {
		this.v1 = v1;
		this.v2 = v2;
		this.val = val;
	}
	
	public ConstraintEqualityVarPlusConsABS(Constraint original) {
	...
	public String constraintClassCheck() {
    	return "ConstraintEqualityVarPlusConsABS";
    }
	...
	protected void reduce() {
		val = val.replaceAll("[^0-9]", "");
		v1.d.ABSReduceA(v1, v2, Integer.parseInt(val));
		v2.d.ABSReduceB(v1, v2, Integer.parseInt(val));
	}
}